...
<p align="center">
  <img src="https://img.shields.io/badge/status-v0.1.1-blue" alt="狀態: v0.1.1">
...
> [!NOTE]
> v0.1.1 是目前版本。原始碼建置、獨立 npm 套件與三個執行環境整合皆由發布工作流程驗證。
...
發布成品與驗證說明可在 GitHub Release 中查看。詳情請參閱
